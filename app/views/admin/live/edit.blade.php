...
@section('content')
    ...
    <form class="form-horizontal"  method="post" action="/adm/live/edit-live" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="url" name="url"  value="{{$live->url}}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group" >
            ...
            <div class="col-sm-10">
                <script id="description" name="description" type="text/plain">{{$live->description}}</script>
                <script type="text/javascript">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control ui_timepicker" id="start_time" name="start_time" value="{{$live->start_time}}">
            </div>
        </div>
        <div class="form-group">
            <label for="end_time" class="col-sm-2 control-label"><span style="color:red;">*</span>直播结束时间</label>
            <div class="col-sm-10">
                <input type="text" class="form-control ui_timepicker" id="end_time" name="end_time" value="{{$live->end_time}}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <input type="hidden" class="form-control" id="photo" name="photo" value="{{$live->photo}}">
                <img style="width:320px; height:200px;" alt="" id="thumb" src="{{$live->photo}}"  />
            </div>
        </div>
        <div class="form-group">
