...
<div class="head">
    <div class="nav">
        <ul class="nav_body">
            <li><a href="/">首页</a></li>
            <li><a href="/front/forum" class="current">名家讲堂</a></li>
...
<div class="main">
    <div class="online">
        <div class="online_class">
            <div class="online_class_bg"><img src="/front/res/images/last_time_bg.jpg" /></div>
            @if($state == 1)
                        ...
                        <div class="online_export clearfix">
                            <div class="online_export_ship">
                                <div class="online_export_img">
                                    <a href="/front/style/{{$expert->id}}"><img src="{{$expert->photo}}" /></a>
                                </div>
